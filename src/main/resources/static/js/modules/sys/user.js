$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [			
			...
			{ label: '登陆账号', name: 'loginName', width: 75 },
            { label: '用户名称', name: 'name', width: 75 },
            ...
            { label: '保留', name: 'hold', width: 80, formatter: function(value, options, row){
                return value === 1 ?
...
var vm = new Vue({
	...
	methods: {
		...
		add: function(){
			...
			vm.title = "新增";
			vm.roleList = {};
			vm.user = {deptName:null, deptId:null, status:1,hold:1, roleIdList:[]};
