...
//		}
		...
		//用户信息
		SysUserEntity user = sysUserService.queryByUserLoginName(loginName);

		//账号不存在、密码错误
		Boolean pass = new PasswordUtils().validatePassword( password,user.getPassword());
		if(user == null || !pass) {
